...
define('USER', 'cardaplus_novodelivery');

define('PASS', 'edy137090edy');

define('DBSA', 'cardaplus_novodelivery');



define("EMAIL_MSG","seuemail@email.com"); //Email para recebimento e envio de mensagens
...
define('HOME', 'https://cardaplus.com/');  // SEMPRE COM A BARRA NA FRENTE ---- ---- ---- ----
