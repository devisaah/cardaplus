...
<!--[if lte IE 8]>
  ...
  <section class="parallax-window" id="home" data-parallax="scroll" data-image-src="img/sub_header_cart.jpg" data-natural-width="1400" data-natural-height="350">
   ...
   <div id="subheader">
      ...
      <div id="sub_content">
        <img src="/img/logo-marca.png" alt="iFoomeZap" style="width:25%;margin-top:-13%;">
        <h2 style="color: #fff; font-size: 50px !important">Procurando <strong id="js-rotating"><b></b>Restaurantes,Lanchonetes,Hamburguerias,Pizzarias,Sorveterias</b></strong> ?</h2>
        <p>
...
<div class="row">
  ...
  <div class="col-md-3">
    <div class="box_home" id="two">
      ...
      <p>temos os melhores cardápios disponíveis aqui.
      </p>
    </div>
  </div>
  <div class="col-md-3">
